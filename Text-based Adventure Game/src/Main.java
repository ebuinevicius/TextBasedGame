...
public class Main {
	...
	public static void main(String[] args) {
		...
		GAME: // label for while loop
		while (running) {
			System.out.println("------------------------------------------------");
			
			// Create enemy and make it appear
			...
			while (enemyHealth > 0) { 
				...
				if (input.equals("1")) {
					...
					continue GAME; // Jumps back to start of GAME loop
				} 
				else {
			...
			if (health < 1) {
				System.out.println("------------------------------------------------");
				System.out.println("You limp out of the dungeon, weak from battle. GAME OVER!");
				break;
			}
			...
			if (input.equals("1")) {
				...
				System.out.println("You exit the dungeon, successful on your adventures!");
				break;
			}
